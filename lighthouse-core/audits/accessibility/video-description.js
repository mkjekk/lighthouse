...
const UIStrings = {
  /** Title of an accesibility audit that evaluates if all video elements have child track elements that contain a description of the video content. This descriptive title is shown to users when no user action is required. */
  title: '`<video>` elements contain a `<track>` element with `[kind="description"]`',
  /** Title of an accesibility audit that evaluates if all video elements have child track elements that contain a description of the video content. This imperative title is shown to users when there is a failure that needs to be addressed. */
