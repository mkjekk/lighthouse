...
const UIStrings = {
  /** Title of an accesibility audit that evaluates if the page has a <title> element that describes the page. This descriptive title is shown to users when no user action is required. */
  title: 'Document has a `<title>` element',
  /** Title of an accesibility audit that evaluates if the page has a <title> element that describes the page. This imperative title is shown to users when there is a failure that needs to be addressed. */
