...
const UIStrings = {
  /** Title of an accesibility audit that evaluates if all table cell elements in a table that use the headers HTML attribute use it correctly to refer to cells within the same table. This descriptive title is shown to users when no user action is required. */
  title: 'Cells in a `<table>` element that use the `[headers]` attribute only refer ' +
      'to other cells of that same table.',
  /** Title of an accesibility audit that evaluates if all table cell elements in a table that use the headers HTML attribute use it correctly to refer to cells within the same table. This imperative title is shown to users when there is a failure that needs to be addressed. */
