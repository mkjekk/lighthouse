...
const UIStrings = {
  /** Title of an accesibility audit that evaluates if there are any duplicate id HTML attributes on the page. This descriptive title is shown to users when no user action is required. */
  title: '`[id]` attributes on the page are unique',
  /** Title of an accesibility audit that evaluates if there are any duplicate id HTML attributes on the page. This imperative title is shown to users when there is a failure that needs to be addressed. */
