...
const UIStrings = {
  /** Title of an accesibility audit that evaluates if all object elements have an alt HTML attribute that describes their contents. This descriptive title is shown to users when no user action is required. */
  title: '`<object>` elements have `[alt]` text',
  /** Title of an accesibility audit that evaluates if all object elements have an alt HTML attribute that describes their contents. This imperative title is shown to users when there is a failure that needs to be addressed. */
